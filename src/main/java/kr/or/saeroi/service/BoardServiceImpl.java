...
public class BoardServiceImpl implements BoardService {
	...
	// 공지 등록
	@Override
	public int _ser_insert_Notice(int notice_id, String title, String content, String empno, String status, String remark) {
		return boardDAO._dao_insert_Notice(notice_id, title, content, empno, status, remark);
	}

	// 공지 첨부파일 등록
	@Override
	public int _ser_insert_Notice_file(int notice_id, String file_title, String saved_title, String file_path, long file_size) {
