...
public class DefectDTO {
	...
	public String getAction_dept() {
		return action_dept;
	}

	public void setAction_dept(String action_dept) {
		this.action_dept = action_dept;
	}
