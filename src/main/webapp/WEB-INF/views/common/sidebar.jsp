			...
			<c:when test="${Worker}">
				<aside id="siSidebar" class="siSidebar">
						...
						<div class="siLogoBox">
								...
								<img src="${pageContext.request.contextPath}/resources/saeroi_logo.png" alt="SAEROI 로고"
									class="siLogo">
							...
							<div class="siUserBox">
									...
									<div class="siUserInfoText">
											...
											<p class="siUserName">${not empty sessionScope.loginUser
												? sessionScope.loginUser.ename.concat(' 님')
												: '로그인 필요'}
											</p>

											<p class="siUserRole">${not empty sessionScope.loginUser
												? sessionScope.loginUser.dept.concat('
												').concat(sessionScope.loginUser.job)
												: ''}
											</p>
										...
										<div class="siMenuGroup">
												...
												<button type="button" class="siMenuTitle" data-main-menu="대시보드">
													...
													<div class="siSubMenu">
															...
															<a href="${pageContext.request.contextPath}/board/notice"
																class="siSubMenuLink" data-main-menu="대시보드"
																data-sub-menu="공지사항">
																공지사항
															</a> <a
																href="${pageContext.request.contextPath}/board/suggestion"
																class="siSubMenuLink" data-main-menu="대시보드"
																data-sub-menu="게시판">
																게시판
															</a>
											...
											<div class="siMenuGroup">
													...
													<button type="button" class="siMenuTitle" data-main-menu="생산관리">
															...
															<span class="siMenuName">생산관리</span> <span
																class="siMenuArrow">
																<svg class="siMenuArrowSvg" viewBox="0 0 24 24">
																	<path d="M6 9L12 15L18 9"></path>
																</svg>
													...
													<div class="siSubMenu">
															...
															<%-- 작업자 권한일 때 작업자 전용 작업지시 주소로 이동 --%>
															<a href="${pageContext.request.contextPath}/worker/workorder"
																class="siSubMenuLink" data-main-menu="생산관리"
																data-sub-menu="작업지시 관리">
																작업지시 관리
															</a> <a
																href="${pageContext.request.contextPath}/worker/productionresult"
																class="siSubMenuLink" data-main-menu="생산관리"
																data-sub-menu="생산실적 등록">
																<%-- 작업자 권한일 때 작업자 전용 생산실적 주소로 이동 --%>
																생산실적 등록
															</a>
												...
												<%-- 자재/재고 관리 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
													...
													<button type="button" class="siMenuTitle" data-main-menu="자재/재고 관리">
														<%-- 자재/재고 관리 하위 메뉴를 열고 닫는 버튼이다. --%>
															...
															<span class="siMenuName">자재/재고 관리</span> <span
																class="siMenuArrow">
																<svg class="siMenuArrowSvg" viewBox="0 0 24 24">
																	<path d="M6 9L12 15L18 9"></path>
																</svg>
													...
													<div class="siSubMenu">
														<%-- 자재/재고 관리 하위 메뉴 영역이다. --%>
															...
															<a href="${pageContext.request.contextPath}/inventory/materialIn"
																...
																data-sub-menu="자재(입)출고 관리"> <%-- 자재 입고와 출고를 한 화면에서 관리하는
																	메뉴이다. --%> 자재(입)출고 관리
															</a> <a
																href="${pageContext.request.contextPath}/inventory/inventoryStatus"
																class="siSubMenuLink" data-main-menu="자재/재고 관리"
																data-sub-menu="재고조회 관리"> <%-- 현재 재고 수량과 재고 상태를 조회하는
																	메뉴이다. --%>
																	재고조회 관리
															</a>
													...
													<%-- 생산관리 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
														...
														<div class="siSubMenu">
															<%-- 생산관리 하위 메뉴 영역이다. --%>
																...
																<a href="${pageContext.request.contextPath}/production/productionplan"
																	class="siSubMenuLink" data-main-menu="생산관리"
																	data-sub-menu="생산계획 관리">
																	<%-- 생산계획을 등록하고 관리하는 메뉴이다. --%> 생산계획 관리
																</a> <a
																	href="${pageContext.request.contextPath}/production/workorder"
																	class="siSubMenuLink" data-main-menu="생산관리"
																	data-sub-menu="작업지시 관리">
												...
												<%-- 생산관리 메뉴 그룹을 끝낸다. --%>
													...
													<div class="siMenuGroup">
														<%-- 품질관리 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
															...
															<button type="button" class="siMenuTitle"
																data-main-menu="품질관리">
																<%-- 품질관리 하위 메뉴를 열고 닫는 버튼이다. --%>

																	<span class="siMenuName">품질관리</span> <span
																		class="siMenuArrow">
																		<svg class="siMenuArrowSvg" viewBox="0 0 24 24">
																			<path d="M6 9L12 15L18 9"></path>
																		</svg>
															...
															<div class="siSubMenu">
																<%-- 품질관리 하위 메뉴 영역이다. --%>
																	...
																	<a href="${pageContext.request.contextPath}/quality/inspection"
																		class="siSubMenuLink" data-main-menu="품질관리"
																		data-sub-menu="검사관리">
																		<%-- 검사 정보를 등록하고 조회하는 메뉴이다. --%> 검사관리
																	</a> <a
																		href="${pageContext.request.contextPath}/quality/defect"
																		class="siSubMenuLink" data-main-menu="품질관리"
																		data-sub-menu="불량관리">
													...
													<%-- 품질관리 메뉴 그룹을 끝낸다. --%>
															...
															<%-- 설비관리 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
																...
																<button type="button" class="siMenuTitle"
																	...
																	<%-- 설비관리 하위 메뉴를 열고 닫는 버튼이다. --%>
																		...
																		<span class="siMenuName">설비관리</span> <span
																			class="siMenuArrow">
																			<svg class="siMenuArrowSvg"
																				viewBox="0 0 24 24">
																				<path d="M6 9L12 15L18 9"></path>
																			</svg>
																		</span>
																...
																<div class="siSubMenu">
																	<%-- 설비관리 하위 메뉴 영역이다. --%>
																		...
																		<a href="${pageContext.request.contextPath}/equipment/equipment"
																			...
																			class="siSubMenuLink" data-main-menu="설비관리"
																			data-sub-menu="설비 가동 현황"> <%-- 설비가 가동 중인지
																				비가동 중인지 확인하는 메뉴이다. --%> 설비 가동 현황
																		</a>
														...
														<%-- 설비관리 메뉴 그룹을 끝낸다. --%>
															...
															<a href="${pageContext.request.contextPath}/report"
																class="siMenuSingle" data-main-menu="리포트"
																data-sub-menu=""> <%-- 생산 리포트와 품질 리포트를 한 화면에서 확인하는 단독
																	메뉴이다. --%>
																	리포트
															</a> <a
																href="${pageContext.request.contextPath}/lot/lothistory"
																class="siMenuSingle" data-main-menu="LOT 이력추적"
																data-sub-menu="">
																<%-- LOT 번호 기준으로 생산, 공정, 품질 이력을 한 번에 조회하는 단독 메뉴이다. --%>
																	LOT 이력추적
															</a>
															...
															<div class="siMenuGroup">
																<%-- 기준정보관리 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
																	...
																	<button type="button" class="siMenuTitle"
																		data-main-menu="기준정보관리">
																		<%-- 기준정보관리 하위 메뉴를 열고 닫는 버튼이다. --%>

																			<span class="siMenuName">기준정보관리</span> <span
																				class="siMenuArrow">
																				<svg class="siMenuArrowSvg"
																					viewBox="0 0 24 24">
																					<path d="M6 9L12 15L18 9"></path>
																	...
																	<div class="siSubMenu">
																		<%-- 기준정보관리 하위 메뉴 영역이다. --%>
																			...
																			<a href="${pageContext.request.contextPath}/master/item"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="품목 기준관리"> <%-- 제품과 자재 품목의
																					기준정보를 관리하는 메뉴이다. --%>
																					품목 기준관리
																			</a> <a
																				href="${pageContext.request.contextPath}/master/bom"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="BOM 기준관리"> <%-- 제품을 만들 때
																					필요한 자재 구성 정보를 관리하는 메뉴이다. --%> BOM
																					기준관리
																			</a> <a
																				href="${pageContext.request.contextPath}/master/process"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="공정 기준관리"> <%-- 생산 공정의
																					기준정보를 관리하는 메뉴이다. --%> 공정
																					기준관리
																			</a> <a
																				...
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="설비 기준관리"> <%-- 설비명, 설비코드
																					같은 설비 기준정보를 관리하는 메뉴이다. --%>
																					설비 기준관리
																			</a> <a
																				href="${pageContext.request.contextPath}/master/client"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="거래처 기준관리"> <%-- 거래처 기준정보를
																					관리하는 메뉴이다. --%> 거래처
																					기준관리
																			</a> <a
																				href="${pageContext.request.contextPath}/master/defectcode"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="불량코드 기준관리"> <%-- 불량 유형을
																					코드로 관리하기 위한 메뉴이다. --%> 불량코드 기준관리
																			</a> <a
																				href="${pageContext.request.contextPath}/system/userauth"
																				class="siSubMenuLink"
																				data-main-menu="기준정보관리"
																				data-sub-menu="사용자/권한 기준관리"> <%-- 사용자
																					계정과 권한 정보를 관리하는 메뉴이다. 기존 시스템 관리 대메뉴
																					대신 기준정보관리 안에 배치한다. --%> 사용자/권한 기준관리
																			</a>
