									...
									<%-- 사용자 프로필 사진이 들어가는 영역이다. --%>
										<%-- 현재는 테스트 이미지이고, 나중에는 DB에서 가져온 사용자 프로필 이미지 경로로 변경한다. --%>
											...
											<img src="${pageContext.request.contextPath}/resources/kim.png"
												alt="사용자 프로필 사진">
											<%-- 현재 테스트용 프로필 이미지이다. 실제 프로젝트에서는 로그인한 사용자의 DB 이미지 경로를 받아서 src에 넣어야 한다. 예:
														...
														<div class="siSubMenu">
															<%-- 설비관리 하위 메뉴 영역이다. --%>
																...
																<a href="${pageContext.request.contextPath}/equipment/equipment"
																	...
																	class="siSubMenuLink" data-main-menu="설비관리"
																	data-sub-menu="설비 가동 현황"> <%-- 설비가 가동 중인지 비가동 중인지
																		확인하는 메뉴이다. --%>
																		설비 가동 현황
																</a>
														...
														<%-- 리포트 큰 메뉴와 하위 메뉴를 묶는 영역이다. --%>
															...
															<button type="button" class="siMenuTitle"
																...
																<%-- 리포트 하위 메뉴를 열고 닫는 버튼이다. --%>
																	...
																	<span class="siMenuName">리포트</span> <span
																		class="siMenuArrow">
																		<svg class="siMenuArrowSvg" viewBox="0 0 24 24">
																			<path d="M6 9L12 15L18 9"></path>
																		</svg>
															...
															<div class="siSubMenu">
																<%-- 리포트 하위 메뉴 영역이다. --%>
																	...
																	<a href="${pageContext.request.contextPath}/report/productionreport"
																		class="siSubMenuLink" data-main-menu="리포트"
																		data-sub-menu="생산 리포트">
																		<%-- 생산 결과를 리포트 형태로 확인하는 메뉴이다. --%> 생산 리포트
																	</a> <a
																		href="${pageContext.request.contextPath}/report/qualityreport"
																		class="siSubMenuLink" data-main-menu="리포트"
																		data-sub-menu="품질 리포트">
																...
																<div class="siSubMenu">
																	<%-- 기준정보관리 하위 메뉴 영역이다. --%>
																		...
																		<a href="${pageContext.request.contextPath}/master/item"
																			...
																			data-main-menu="기준정보관리"
																			data-sub-menu="설비관리">
																			<%-- 설비명, 설비코드 같은 설비 기준정보를 관리하는 메뉴이다. --%>
																				설비관리
																		</a> <a
