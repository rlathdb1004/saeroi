...
<c:choose>
	...
	<c:otherwise>
		<c:url var="logoHomeUrl" value="/dashboard" />
	</c:otherwise>
</c:choose>
	...
	<c:when test="${Worker}">
		<aside id="siSidebar" class="siSidebar">
			...
			<div class="siLogoBox">
				...
				<a href="${logoHomeUrl}" class="siLogoLink" aria-label="메인으로 이동">
			...
			<nav class="siMenu">
				...
				<div class="siMenuGroup">
					...
					<button type="button" class="siMenuTitle" data-main-menu="대시보드">
						...
						<span class="siMenuName">대시보드</span> <span class="siMenuArrow">
				...
				<div class="siMenuGroup">
					...
					<div class="siSubMenu">
						...
						<a href="${pageContext.request.contextPath}/worker/workorder"
							...
							data-sub-menu="작업지시 관리"> 작업지시 관리 </a> <a
							href="${pageContext.request.contextPath}/worker/productionresult"
							class="siSubMenuLink" data-main-menu="생산관리"
							data-sub-menu="생산실적 등록"> <%-- 작업자 권한일 때 작업자 전용 생산실적 주소로 이동 --%>
							생산실적 등록
						</a>
		...
		<aside id="siSidebar" class="siSidebar">
			...
			<div class="siLogoBox">
				...
				<a href="${logoHomeUrl}" class="siLogoLink" aria-label="메인으로 이동">
					...
					<img
					src="${pageContext.request.contextPath}/resources/saeroi_logo.png"
					alt="SAEROI 로고" class="siLogo"> <%-- contextPath를 붙여서 프로젝트명이 바뀌어도 로고 이미지 경로가 깨지지 않도록 한다. --%>

					<p class="siLogoText">EV용 배터리 절연 가스켓 제조 MES</p> <%-- 로고 아래에 프로젝트 시스템 설명 문구를 표시한다. --%>
			...
			<nav class="siMenu">
				...
				<div class="siMenuGroup">
					...
					<div class="siSubMenu">
						...
						<a
							...
							class="siSubMenuLink" data-main-menu="생산관리"
							data-sub-menu="생산계획 관리"> <%-- 생산계획을 등록하고 관리하는 메뉴이다. --%> 생산계획
							관리
						</a> <a href="${pageContext.request.contextPath}/production/workorder"
							class="siSubMenuLink" data-main-menu="생산관리"
							data-sub-menu="작업지시 관리"> <%-- 생산계획을 기준으로 작업지시를 관리하는 메뉴이다. --%>
							작업지시 관리
						</a> <a
							href="${pageContext.request.contextPath}/production/productionresult"
							class="siSubMenuLink" data-main-menu="생산관리"
							data-sub-menu="생산실적 등록"> <%-- 작업 완료 수량과 생산 결과를 등록하는 메뉴이다. --%>
							생산실적 등록
						</a> <a
							href="${pageContext.request.contextPath}/production/processprogress"
							class="siSubMenuLink" data-main-menu="생산관리"
							data-sub-menu="공정진행 현황"> <%-- 공정별 진행 상태를 확인하는 메뉴이다. --%> 공정진행
							현황
						</a>
				...
				<a href="${pageContext.request.contextPath}/report"
					class="siMenuSingle" data-main-menu="리포트" data-sub-menu=""> <%-- 생산 리포트와 품질 리포트를 한 화면에서 확인하는 단독
																	메뉴이다. --%> 리포트
