...
<header class="heHeader">
	...
	<div class="heLeftBox">
		...
		<div id="heCurrentMenuBox" class="heCurrentMenuBox heHidden">
			<%-- 사이드바에서 하위 메뉴를 클릭했을 때만 보이는 영역이다. --%>

			<a href="#" id="heCurrentMenu" class="heCurrentMenu active"></a>
			<%-- 사이드바에서 클릭한 하위 메뉴명이 들어갈 자리이다. --%>
	...
	<div class="heRightBox">
		...
		<div class="heInfoBox">
			...
			<p class="heInfoLabel heWeatherLabel">오늘 온도</p>
			<%-- 오늘 온도라는 작은 제목이다. --%>
