...
<div class="coPageWrap">
	...
	<form class="search-form" method="get"
		action="${pageContext.request.contextPath}/board/board">
			...
			<div class="search-row">
				...
				<div class="search-btn-wrap">
					...
					<button type="button"
						...
						onclick="location.href='${pageContext.request.contextPath}/board/board'">
						<svg viewBox="0 0 24 24" fill="none">
							<path
	...
	<form method="post" id="deleteForm" accept-charset="UTF-8"
		action="${pageContext.request.contextPath}/board/board/delete">
			...
			<c:if test="${isLogin}">
				<div class="search-btn-right">
					...
					<button type="button" class="search-btn search-btn-main"
						onclick="location.href='${pageContext.request.contextPath}/board/board/add'">
						<svg viewBox="0 0 24 24" fill="none">
				...
				<tbody>
					<c:forEach var="board" items="${list}">
						<tr>
							...
							<td class="mobile_show">
								<c:choose>
									<c:when test="${board.status == '완료'
										or board.status == '처리완료'
										or board.status == '답변완료'}">
							...
							<td class="mobile_hidden">${board.empno}</td>
							...
							<td class="mobile_show">
								<button type="button" class="coDetailBtn"
									onclick="location.href='${pageContext.request.contextPath}/board/board/detail?board_id=${board.board_id}'">
									보기
								</button>
							</td>
						</tr>
