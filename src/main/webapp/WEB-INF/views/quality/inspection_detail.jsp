				...
				<tbody>
					...
					<tr>
						...
						<td><c:choose>
								<c:when test="${inspection.result == '조건부'}">
									<span
										class="detailText detail_status_badge inspection_status_conditional">${inspection.result}</span>
								</c:when>
								<c:otherwise>
									<span class="detailText detail_status_badge detail_status_pass">${inspection.result}</span>
								</c:otherwise>
							</c:choose> <select name="result" class="detailInput" style="display: none;"
							required>
								<option value="합격"
					...
					<tr>
						...
						<td><span class="detailText">${inspection.good_qty}</span> <input
							...
							value="${inspection.good_qty}" style="display: none;" min="0"
							required></td>
					</tr>
