/*
    ...
    주의   : 테이블명/컬럼명은 원본 파일의 큰따옴표 구조를 유지했다.
             따라서 SQL 작성 시 테이블명과 컬럼명을 큰따옴표로 감싸는 기준을 따른다.
*/
...
-- 기본키(PK) 제약조건
-- ============================================================
ALTER TABLE "comment" ADD CONSTRAINT "PK_CMT" PRIMARY KEY (
	"comment_id"
);
...
-- 외래키(FK) 제약조건
-- ============================================================
ALTER TABLE "comment" ADD CONSTRAINT "FK_CMT_BOARD" FOREIGN KEY (
	"board_id"
)
REFERENCES "board" (
	"board_id"
...
-- 외래키(FK) 제약조건
-- ============================================================
ALTER TABLE "comment" ADD CONSTRAINT "FK_CMT_PARENT" FOREIGN KEY (
	"parent_comment_id"
)
REFERENCES "comment" (
	"comment_id"
...
-- 외래키(FK) 제약조건
-- ============================================================
ALTER TABLE "comment" ADD CONSTRAINT "FK_CMT_EMP" FOREIGN KEY (
	"emp_id"
)
REFERENCES "emp" (
	"emp_id"
...
-- 외래키(FK) 제약조건
-- ============================================================
ALTER TABLE "file" ADD CONSTRAINT "FK_FILE_NTC" FOREIGN KEY (
	"notice_id"
)
REFERENCES "notice" (
	"notice_id"
...
-- 외래키(FK) 제약조건
-- ============================================================
ALTER TABLE "file" ADD CONSTRAINT "FK_FILE_BOARD" FOREIGN KEY (
	"board_id"
)
REFERENCES "board" (
	"board_id"
