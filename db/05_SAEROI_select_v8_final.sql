/*
    파일명 : 05_SAEROI_select_v8_final.sql
...
FROM (
    ...
    UNION ALL SELECT 26, 'comment', COUNT(*) FROM "comment"
    UNION ALL SELECT 27, 'file', COUNT(*) FROM "file"
)
ORDER BY ord;
...
UNION ALL SELECT 'comment', "comment_id", LENGTH("remark"), "remark" FROM "comment" WHERE LENGTH("remark") > 30
